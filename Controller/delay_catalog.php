    ...
    while ($n < count($borrowed_books)) {
        ...
        if ($db_status == 1 || $db_status == 2) { // 0 - returned, 1 - borrowing, 2 - overtime 3 - lost the book
            ...
            <div class="item">
                ...
                <br>
                <button class="borrow-button" onclick="displayBorrowWindow()">Make Extension of This Book</button>
            </div>
_END;
        }
        $n ++;
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="content">
            ...
            <img src="ayase2.png" id="imgs" alt="ayase">
            <p id="booktitle">"Book title"</p>
            <form id="returnForm" action="Controller/DelayBook.php" method="post">
                <input id="bookId" type="hidden" name="bookID">
                <input id="username" type="hidden" name="username">
                <br>additional days <input type="text" name="additional_days">
                reason of delay <input type="text" name="reason_of_delay">
