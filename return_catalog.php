    ...
    while ($n < count($borrowed_books)) {
        ...
        if ($db_status == 1 || $db_status == 2) { // 0 - returned, 1 - borrowing, 2 - overtime 3 - lost the book
            ...
            <div class="item">
                ...
                <br>
                <button class="borrow-button" onclick="displayBorrowWindow()">Return This Book</button>
            </div>
_END;
        }
        $n ++;
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="content">
            ...
            <form id="returnForm" action="Controller/ReturnBook.php" method="post">
